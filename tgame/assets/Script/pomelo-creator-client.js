...
(function() {
  ...
  var connect = function(params, url, cb) {
    ...
    if(myStorage && myStorage.getItem('protos') && protoVersion === 0) {
      var protos = JSON.parse(myStorage.getItem('protos'));
  ...
  var initData = function(data) {
    ...
    if(protos) {
      ...
      clientProtos = protos.client || {};
        ...
        myStorage.setItem('protos', JSON.stringify(protos));
