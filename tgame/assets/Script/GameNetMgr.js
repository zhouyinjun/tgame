cc.Class({
    ...
    initHandlers:function(){
        ...
        cc.vv.net.addHandler("new_user_coming_push",function(data){
            //console.log(data);
    ...
    connectGameServer:function(data,callback){
        ...
        var onConnectOK = function(){
            ...
            pomelo.request("connector.entryHandler.entry",sd,callback);
        };
        ...
        cc.vv.net.connect(onConnectOK,onConnectFailed,data.userId);
    }
