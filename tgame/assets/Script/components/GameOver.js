cc.Class({
    ...
    onLoad: function () {
       ...
       // this._gameresult = this.node.getChildByName("game_result");
        ...
        for(var i = 1; i <= 4; ++i){
            ...
            viewdata.gangshu = sn.getChildByName('gangshu').getComponent(cc.Label);
    ...
    onGameOver: function(data){
        ...
        for(var i = 0; i < 4; ++i){
            ...
            {
                seatView.hu.children[1].active = true;
            }
            ...
            if(numOfGangs>0)
            {
                seatView.gangshu.string = "杠 X "+numOfGangs;
            }
            else
            {
                seatView.gangshu.string = "";
            }
    ...
    onBtnReadyClicked:function(){
       ...
       pomelo.notify("mjarea.mjHandler.ready");
        this._gameover.active = false;
    },
